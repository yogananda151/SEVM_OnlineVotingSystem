...
router.get('/my/assigned', (0, auth_middleware_1.authorize)(client_1.UserRole.OFFICER), election_controller_1.electionController.getMyElections.bind(election_controller_1.electionController));
